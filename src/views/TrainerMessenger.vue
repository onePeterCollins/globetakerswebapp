              ...
              <v-card class="col-12 col-lg-10">
                ...
                <v-row>
                  ...
                  <v-col class="col-12 col-lg-6">
                    <v-btn v-if="notification.getAudience() !== 'tutors'" class="mx-2 mb-3 g-deepblue--text" @click="setAudience(1)">
                      <v-icon class="mr-2">mdi-account-group</v-icon>
                      Trainers
                    </v-btn>

                    <v-btn v-if="notification.getAudience() === 'tutors'" class="mx-2 mb-3 g-rose--text" @click="setAudience(1)">
                      <v-icon class="mr-2">mdi-account-group</v-icon>
                      Trainers
                    </v-btn>
...
export default {
  ...
  mounted() {
    this.notification.setAudienceIndex(1)
